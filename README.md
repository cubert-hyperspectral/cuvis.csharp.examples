...
Then, you need to install the Cuvis C SDK (see [here](https://cloud.cubert-gmbh.de/s/q3YiPZPJe5oXziZ)), as explained for the C# wrapper [here](https://github.com/cubert-hyperspectral/cuvis.csharp).
